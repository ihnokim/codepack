...
from codepack.interface import DynamoDB
import pytest
...
def test_dynamodb_select(mock_client):
    ...
    ret = d.select(table='codepack', columns=['c1', 'c2', 'c3'], test_key1='test_value1', test_key2=123, test_key3=1.23)
